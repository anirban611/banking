function sendMoney() {
   ...
   if (enterAmount > enterSAmount) {
      ...
      var textNode = document.createTextNode(`Rs ${enterAmount} is sent from the sender with Gmail-id ${enterSName}@gmail.com
  to recepient with Gmail-id ${enterName}@gmail.com on ${Date()}.`);
